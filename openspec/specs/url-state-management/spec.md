...
This spec defines requirements for passing application state via URL query parameters instead of localStorage, enabling better browser history behavior and bookmarkability.
